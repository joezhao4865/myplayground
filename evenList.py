...
def filterEvenNumberAtEvenPos(*nums):
    return lambda: [nums[i] for i in range(len(nums)) if isinstance(nums[i], (int,)) and i % 2==0 and nums[i] % 2 == 0]
        

'''
if __name__ == "__main__":
    print(filterEvenNumberatEvenPos(1,2,2,4,2,6,10,8,4,10)())
    #print(checkAllInts(1,2,2,4,2,6,10,8,4,10))
